...
public class LoginTest extends ActivityInstrumentationTestCase2<LoginActivity> {
    ...
    public void testLoginByCorrectNameAndPwd() {
        onView(withId(R.id.edtUserName)).perform(clearText(), typeText(CORRECT_USER_NAME));// 用户名设置
        onView(withId(R.id.edtUserPwd)).perform(clearText(), typeText(CORRECT_USER_PWD));// 密码设置
